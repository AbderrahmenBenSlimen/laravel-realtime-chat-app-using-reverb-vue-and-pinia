...
Route::get('/rooms/{room:slug}/messages', MessageIndexController::class)->middleware(['auth', 'verified'])->name('room.index.messages');
Route::post('/rooms/{room:slug}/messages', MessageStoreController::class)->middleware(['auth', 'verified']);
